...
export function createDemoGraphState(): GraphState {
  ...
  return {
    ...
    nodes: [
      ...
      {
        nodeId: 'sess-p3-release',
        sessionId: 'sess-p3-release',
        label: 'P3 Release prep',
        role: 'worker',
        agent: 'claude-code',
        status: 'running',
      ...
      {
        nodeId: 'sess-p4-staging',
        sessionId: 'sess-p4-staging',
        label: 'P4 Staging config',
        role: 'worker',
        agent: 'claude-code',
        status: 'running',
        position: { x: 0, y: 300 },
      ...
      {
        nodeId: 'sess-p5-sim',
        sessionId: 'sess-p5-sim',
        label: 'P5 Simulator setup',
        role: 'worker',
        agent: 'claude-code',
        status: 'failed',
    ...
    sessions: {
      ...
      'sess-p3-release': {
        ...
        nodeId: 'sess-p3-release',
        backend: 'claude-agent-sdk',
        backendSessionId: 'c4d81f22-5e0a-4b7f-a1c3-8890e3b1a201',
        providerKind: 'claude-code',
        providerInstanceId: 'default-claude-sdk',
        providerSessionId: 'c4d81f22-5e0a-4b7f-a1c3-8890e3b1a201',
        agent: 'claude-code',
        label: 'P3 Release prep',
        prompt: 'Normalize the open PR titles to conventional-commit style.',
        cwd: '~/Documents/GitHub/orrery',
        role: 'worker',
        status: 'running',
        createdAt: `${base}4:00.000Z`,
        updatedAt: `${base}6:20.000Z`,
        chunks: [],
        nativeEvents: [],
        runtimeEvents: [],
        runtimeActivities: [],
        runtimeRequests: [
          {
            id: 'req-p3-1',
            sessionId: 'sess-p3-release',
            turnId: 'turn-p3-release',
            kind: 'permission',
            title: 'gh pr edit 3831 --title "fix(mobile): sidebar overflow"',
            body: 'Wants to rename 4 open PRs to conventional-commit style.',
            status: 'open',
            createdAt: `${base}6:20.000Z`,
          },
        ],
        runtimeUserInputRequests: [],
        runtimePlans: [],
        messages: [
          {
            ...
            sessionId: 'sess-p3-release',
            role: 'user',
            content: 'Normalize the open PR titles to conventional-commit style.',
            ts: `${base}4:00.000Z`,
            status: 'complete',
          },
        ],
      ...
      'sess-p4-staging': {
        ...
        nodeId: 'sess-p4-staging',
        backend: 'claude-agent-sdk',
        backendSessionId: 'e7a90c15-3fb2-47d8-b6e4-11c2d0f4b7c3',
        providerKind: 'claude-code',
        providerInstanceId: 'default-claude-sdk',
        providerSessionId: 'e7a90c15-3fb2-47d8-b6e4-11c2d0f4b7c3',
        agent: 'claude-code',
        label: 'P4 Staging config',
        prompt: 'Fix the image upload stalls on staging.',
        cwd: '~/Documents/GitHub/orrery',
        role: 'worker',
        status: 'running',
        createdAt: `${base}3:40.000Z`,
        updatedAt: `${base}6:05.000Z`,
        chunks: [],
        nativeEvents: [],
        runtimeEvents: [],
        runtimeActivities: [],
        ...
        runtimeUserInputRequests: [
          {
            id: 'input-p4-1',
            sessionId: 'sess-p4-staging',
            turnId: 'turn-p4-staging',
            prompt: 'Which bucket should staging use? I found both file-host-staging and file-host-dev configured.',
            status: 'open',
            createdAt: `${base}6:05.000Z`,
          },
        ],
        runtimePlans: [],
        messages: [
          {
            ...
            sessionId: 'sess-p4-staging',
            role: 'user',
            content: 'Fix the image upload stalls on staging.',
            ts: `${base}3:40.000Z`,
            status: 'complete',
          },
        ],
      ...
      'sess-p5-sim': {
        ...
        nodeId: 'sess-p5-sim',
        backend: 'claude-agent-sdk',
        backendSessionId: 'f2b64d09-88e1-4a25-9c07-64d5a2e9f0b8',
        providerKind: 'claude-code',
        providerInstanceId: 'default-claude-sdk',
        providerSessionId: 'f2b64d09-88e1-4a25-9c07-64d5a2e9f0b8',
        agent: 'claude-code',
        label: 'P5 Simulator setup',
        prompt: 'Set up remote iOS Simulator access for the QA loop.',
        cwd: '~/Documents/GitHub/orrery',
        role: 'worker',
        status: 'failed',
        createdAt: `${base}2:00.000Z`,
        updatedAt: `${base}5:20.000Z`,
        exitCode: 1,
        error: 'Simulator lookup timed out (120s). Session ended with an error.',
        chunks: [],
        nativeEvents: [],
        runtimeEvents: [],
        runtimeActivities: [],
        ...
        messages: [
          {
            ...
            sessionId: 'sess-p5-sim',
            role: 'user',
            content: 'Set up remote iOS Simulator access for the QA loop.',
            ts: `${base}2:00.000Z`,
            status: 'complete',
          },
          {
            ...
            sessionId: 'sess-p5-sim',
            role: 'assistant',
            content: 'The direct Simulator lookup still timed out after 120 seconds.',
            ts: `${base}5:19.000Z`,
            status: 'complete',
          },
        ],
